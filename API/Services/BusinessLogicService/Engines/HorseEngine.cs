...
internal static class HorseEngine
{
    internal static readonly string[] Names = ["Thunder Bolt", "Lucky Strike", "Iron Duke", "Wild Fire", "Night Shadow", "Silver Fox"];

    private const int   Count   = 6;
    private const double Adv    = 0.27;
    private const int   Payout  = 4;

    internal static (int WinnerIndex, string WinnerName, int Net) Race(int bet, int horseIndex)
    {
